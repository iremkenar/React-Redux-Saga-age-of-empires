export const data = {
  units: [
    ...
    },
    {
      ...
      attack: 9,
      armor: '0/4',
      attack_bonus: ['+10 monks', '+5 siege', '+4 cavalry', '+2 ship/camel'],
    },
    {
      id: 12,
      name: 'Spearman',
    ...
    },
    {
      ...
      attack: 6,
      armor: '0/1',
      attack_bonus: ['+2 eagles', '+1 buildings'],
    },
    {
      id: 17,
      name: 'Long Swordman',
      ...
      attack: 9,
      armor: '0/1',
      attack_bonus: ['+4 eagles', '+2 buildings'],
    },
    {
      id: 18,
      ...
      attack: 11,
      armor: '0/1',
      attack_bonus: ['+6 eagles', '+3 buildings'],
      search_radius: 4,
    },
    {
      id: 19,
    ...
    },
    {
      ...
      name: 'King',
      description:
        'Cannot be produced so the cost and build time just for the sake of interest',
      expansion: 'Age of Kings',
      age: 'Dark',
      cost: {
        Food: 50,
    ...
    },
    {
      ...
      name: 'Cannon Galleon',
      description:
        'Long-range warship used to attack targets on shore to establish beachhead. Fires slowly and has minimum range',
      expansion: 'Age of Kings',
      age: 'Imperial',
      cost: {
        Wood: 200,
    ...
    },
    {
      ...
      attack: 110,
      armor: '0/3',
      attack_bonus: ['+220 buildings'],
      armor_bonus: ['+3 ships/camel'],
      blast_radius: 2.5,
    },
    {
      id: 27,
    ...
    },
    {
      ...
      armor_bonus: ['+7 ships/camel'],
    },
    {
      id: 30,
      name: 'Galley',
      description:
        'Small and fast ship with weak attack. Used to scout the water and for early attacks on enemy fishing fleets',
      expansion: 'Age of Kings',
      age: 'Feudal',
      cost: {
        Wood: 90,
      ...
      attack: 6,
      armor: '0/6',
      attack_bonus: ['+6 buildings', '+8 ships/camels', '+3 rams'],
    },
    {
      id: 31,
      name: 'War Galley',
      ...
      attack: 7,
      armor: '0/6',
      attack_bonus: ['+7 buildings', '+9 ships/camels', '+4 rams'],
    },
    {
      id: 32,
      name: 'Galleon',
      ...
      attack: 8,
      armor: '0/8',
      attack_bonus: ['+8 buildings', '+11 ships/camels', '+4 rams'],
    },
    {
      id: 33,
      name: 'Longboat',
      ...
      attack: 7,
      armor: '0/6',
      attack_bonus: ['+7 buildings', '+9 ships', '+4 rams'],
      accuracy: '100%',
    },
    {
      id: 34,
      ...
      attack: 8,
      armor: '0/8',
      attack_bonus: ['+8 buildings', '+11 ships', '+4 rams'],
      accuracy: '100%',
    },
    {
      id: 35,
    ...
    },
    {
      ...
      name: 'Transport Ship',
      description:
        'Ship to carry units. Garrison inside 5 (10 with careening and 20 with dry dock)',
      expansion: 'Age of Kings',
      age: 'Feudal',
      cost: {
        Wood: 125,
    ...
    },
    {
      ...
      name: 'Turtle Ship',
      description:
        'Korean unique unit. Slow and ironclad battleship used to destroy other ships at close range',
      expansion: 'The Conquerors',
      age: 'Castle',
      cost: {
        Wood: 200,
    ...
    },
    {
      ...
      attack: 50,
      armor: '8/6',
      armor_bonus: ['+11 ships', '+1 turtle ship armor'],
      blast_radius: 0.5,
    },
    {
      id: 40,
    ...
    },
    {
      ...
      name: 'Wolf',
      description:
        'Wild wolf. Gives no food just kills people. Line of sight also depends on difficulty (4-12 LOS)',
      expansion: 'Age of Kings',
      age: 'Dark',
      cost: null,
      reload_time: 2,
    ...
    },
    {
      ...
      name: 'Jaguar',
      description:
        'Wild jaguar. Same as wolf on yucatan and other americas maps',
      expansion: 'Age of Kings',
      age: 'Dark',
      cost: null,
      reload_time: 2,
    ...
    },
    {
      ...
      attack: 40,
      armor: '0/6',
      attack_bonus: ['+35 buildings', '+12 siege'],
      blast_radius: 1,
    },
    {
      id: 52,
      ...
      attack: 50,
      armor: '0/7',
      attack_bonus: ['+45 buildings', '+12 siege'],
      blast_radius: 1.25,
    },
    {
      id: 53,
      ...
      attack: 75,
      armor: '0/8',
      attack_bonus: ['+60 buildings', '+12 siege'],
      blast_radius: 1.5,
    },
    {
      id: 54,
      name: 'Battering Ram',
      description:
        'Slow and lumbering siege weapon used to reduce enemy towns to ruins. Can garrison 4 units (affects movement rate +0.05 per unit)',
      expansion: 'Age of Kings',
      age: 'Castle',
      cost: {
        Wood: 160,
    ...
    },
    {
      ...
      armor_bonus: ['-3 melee', '+1 ram armor'],
      blast_radius: 1.5,
    },
    {
      id: 56,
      name: 'Siege Ram',
      description:
        'Upgraded Capped Ram. Can garrison 6 units (affects movement rate +0.05 per unit)',
      expansion: 'Age of Kings',
      age: 'Imperial',
      cost: {
        Wood: 160,
      ...
      armor_bonus: ['-3 melee', '+2 ram armor'],
      blast_radius: 2,
    },
    {
      id: 57,
      ...
      attack: 12,
      armor: '0/6',
      attack_bonus: ['+2 buildings', '+6 war elephants', '+0 melee', '+1 rams'],
      accuracy: '100%',
    },
    {
      id: 58,
      ...
      attack: 16,
      armor: '0/7',
      attack_bonus: ['+4 buildings', '+8 war elephants', '+0 melee', '+2 rams'],
      accuracy: '100%',
    },
    {
      id: 59,
      name: 'Camel',
      description:
        'Excels at killing other mounted units. (not classified as cavalry)',
      expansion: 'Age of Kings',
      age: 'Castle',
      cost: {
        Food: 55,
      ...
      attack: 5,
      armor: '0/0',
      attack_bonus: ['+10 against cavalry', '+5 ships/camels'],
    },
    {
      id: 60,
      name: 'Heavy Camel',
      description:
        'Upgraded Camel. Attack bonus vs. cavalry. (not classified as cavalry)',
      expansion: 'Age of Kings',
      age: 'Imperial',
      cost: {
        Food: 55,
      ...
      attack: 7,
      armor: '0/0',
      attack_bonus: ['+18 against cavalry', '+9 ships/camels'],
      search_radius: 4,
    },
    {
      id: 61,
    ...
    },
    {
      ...
      name: 'Scout Cavalry',
      description:
        'Fast with extensive line of sight. Resistant to conversion and +2 Line of sight per age',
      expansion: 'Age of Kings',
      age: 'Dark',
      cost: null,
      reload_time: 2,
      ...
      attack: 3,
      armor: '0/2',
      attack_bonus: ['+6 monks'],
    },
    {
      id: 65,
      name: 'Scout Cavalry',
      description:
        'Fast with extensive line of sight. Resistant to conversion +2 Line of sight per age',
      expansion: 'Age of Kings',
      age: 'Feudal',
      cost: {
        Food: 80,
    ...
    },
    {
      ...
      attack: 7,
      armor: '0/2',
      attack_bonus: ['+12 monks'],
    },
    {
      id: 68,
      name: 'Villager',
      description:
        'Gathers resources. Builds and repairs buildings. Also repairs ships and siege weapons',
      expansion: 'Age of Kings',
      age: 'Dark',
      cost: {
        Food: 50,
      ...
      attack: 3,
      armor: '0/0',
      attack_bonus: ['+3 buildings', '+6 stone defense'],
    },
    {
      id: 69,
      name: 'Berserk',
      ...
      attack: 9,
      armor: '0/1',
      attack_bonus: ['+2 eagles', '+2 buildings'],
    },
    {
      id: 70,
      name: 'Elite Berserk',
    ...
    },
    {
      ...
      attack: 9,
      armor: '2/1',
      attack_bonus: ['+9 infantry'],
      armor_bonus: ['+12 cavalry'],
    },
    {
      id: 72,
      ...
      attack: 12,
      armor: '2/1',
      attack_bonus: ['+12 infantry'],
      armor_bonus: ['+16 cavalry'],
    },
    {
      id: 73,
      name: 'Chu Ko Nu',
    ...
    },
    {
      ...
      attack: 18,
      armor: '2/2',
      attack_bonus: ['+6 ram', '+2 buildings'],
      accuracy: '70%',
    },
    {
      id: 77,
      ...
      attack: 10,
      armor: '0/6',
      attack_bonus: ['+2 eagles', '+2 buildings', '+6 archers/hand cannoneers'],
    },
    {
      id: 78,
      name: 'Elite Huskarl',
    ...
    },
    {
      ...
      attack: 10,
      armor: '1/0',
      attack_bonus: ['+12 eagles', '+2 buildings', '+10 infantry'],
    },
    {
      id: 80,
    ...
    },
    {
      ...
      name: 'Janissary',
      description:
        'Turkish unique unit. Hand Cannoneer with longer range and no minimum range',
      expansion: 'Age of Kings',
      age: 'Castle',
      cost: {
        Food: 60,
    ...
    },
    {
      ...
      attack: 7,
      armor: '0/0',
      attack_bonus: ['+9 cavalry'],
      armor_bonus: ['+11 cavalry'],
    },
    {
      id: 86,
      name: 'Elite Mameluke',
    ...
    },
    {
      ...
      attack: 6,
      armor: '0/0',
      attack_bonus: ['+1 spearmen', '+3 siege'],
      search_radius: 5,
      accuracy: '95%',
    },
    {
      ...
      attack: 8,
      armor: '0/1',
      attack_bonus: ['+1 spearmen', '+5 siege'],
      search_radius: 6,
      accuracy: '95%',
    },
    {
      ...
      name: 'Plumed Archer',
      description:
        'Mayan unique unit. Strong fast and well-armored archer with less attack than other archers',
      expansion: 'The Conquerors',
      age: 'Castle',
      cost: {
        Wood: 37,
      ...
      attack: 5,
      armor: '0/1',
      attack_bonus: ['+1 infantry', '+2 spearmen'],
      accuracy: '80%',
    },
    {
      id: 90,
      ...
      attack: 5,
      armor: '0/2',
      attack_bonus: ['+2 infantry', '+2 spearmen'],
      accuracy: '80%',
    },
    {
      id: 91,
      name: 'Samurai',
      description:
        'Japanese unique unit. Infantry with fast attack. Attack bonus vs. other unique units and buildings',
      expansion: 'Age of Kings',
      age: 'Castle',
      cost: {
        Food: 60,
      ...
      attack: 8,
      armor: '1/1',
      attack_bonus: ['+2 eagles', '+2 buildings', '+10 unique units'],
    },
    {
      id: 92,
      name: 'Elite Samurai',
      ...
      attack: 12,
      armor: '1/1',
      attack_bonus: ['+3 eagles', '+3 buildings', '+12 unique units'],
    },
    {
      id: 93,
      name: 'Tarkan',
    ...
    },
    {
      ...
      attack: 12,
      armor: '5/2',
      attack_bonus: ['+4 eagles', '+4 buildings'],
    },
    {
      id: 96,
    ...
    },
    {
      ...
      attack: 7,
      armor: '0/0',
      attack_bonus: ['+1 eagles', '+1 buildings'],
    },
    {
      id: 98,
    ...
    },
    {
      ...
      attack: 15,
      armor: '1/2',
      attack_bonus: ['+7 buildings', '+7 stone defense'],
    },
    {
      id: 100,
      ...
      attack: 20,
      armor: '1/3',
      attack_bonus: ['+10 buildings', '+10 stone defense'],
    },
    {
      id: 101,
      name: 'War Wagon',
      description:
        'Korean unique unit. Heavily armored horse-drawn archery unit',
      expansion: 'The Conquerors',
      age: 'Castle',
      cost: {
        Wood: 120,
    ...
    },
    {
      ...
      name: 'Woad Raider',
      description:
        'Celtic unique unit. Exceptionally quick infantry. Attack bonus vs. buildings',
      expansion: 'Age of Kings',
      age: 'Castle',
      cost: {
        Food: 65,
